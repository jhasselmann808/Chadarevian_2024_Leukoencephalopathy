...
def checkOptions():
    ...
    parser.add_argument('-F', '--File',dest="file_name",required=True,default=None,
                    help='SAM file name to be parsed')
...
def main():
	...
	with gzip.open(sampleName + "_table.tsv.gz",'wt') as f: #output file to store decision table\
		with gzip.open(sampleName + "_mixtable.tsv.gz", "wt") as g:
